...
export interface IndexResult {
  chunks: number;
  skipped: "unchanged" | "low-confidence" | "empty" | "duplicate" | "numeric-loss" | false;
}
...
export async function indexDocument(input: {
  ...
  // Plan 099 Unit 1b — and CHUNKER_VERSION, for the same reason, on every document rather than a
  ...
  // Plan 099 Unit 3b — the standing numeric-integrity guard, checked BEFORE we spend an embedding
