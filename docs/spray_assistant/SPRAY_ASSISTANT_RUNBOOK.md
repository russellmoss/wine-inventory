...
| S0 spike (hourly / LWD / retention) | 1A | 🟩 **complete — gate answered, S1 NARROWED** | [S0 plan](phases/S0-spike-hourly-lwd-retention-plan.md) | [S0 council](phases/S0-council-feedback.md) | branch `claude/spray-intelligence-s0-spike-0f21b2` | [S0 QA](qa/S0-qa-report.md) | [S0 report](phases/S0-report.md) · ADR [0011](../architecture/decisions/0011-hourly-weather-retention-and-replay.md) + [0012](../architecture/decisions/0012-leaf-wetness-estimator-bands-and-refusal.md) |
