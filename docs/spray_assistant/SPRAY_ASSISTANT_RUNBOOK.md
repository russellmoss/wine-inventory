...
| S5a powdery index + latent ledger | 2C | 🟨 **Unit 0 gate ANSWERED — index NO-GO, ledger proceeds** (probe run 2026-07-26; all 8 sites failed; index moved to S5b behind S1) | [S5a plan v2](phases/S5a-powdery-index-latent-ledger-plan.md) | [S5a council](phases/S5a-council-feedback.md) | — | — | [Unit 0 probe](phases/S5a-diurnal-fidelity-probe.md) |
