...
| `src/lib/vendors/vendor-import-core.ts` | acceptCandidateCore, rejectCandidateCore, mergeCandidateIntoVendorCore | ❌ | — | internal |
...
Coverage: **17/21** cores reachable by an assistant tool (2 internal, 2 deferred gap).
