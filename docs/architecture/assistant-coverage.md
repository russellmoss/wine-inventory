...
| `src/lib/ingest/ingest-invoice-core.ts` | createIngestedInvoiceCore, updateIngestedInvoiceLineCore, updateIngestedInvoiceCore, applyIngestedInvoiceCore | ✅ | `ingest-documents` | — |
