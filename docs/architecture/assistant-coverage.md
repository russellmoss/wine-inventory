...
| `src/lib/weather/read-core.ts` | composeClimateSummaryCore | ✅ | `query-climate` | — |
| `src/lib/weather/source-selection-core.ts` | selectPrimaryCore, gapFillCore, computeSpreadCore | ✅ | `query-climate` | — |
