...
| `src/lib/harvest/weigh-tag-core.ts` | createWeighTagCore, voidWeighTagCore | ❌ | — | deferred gap |
...
| `src/lib/owner/change-ownership-core.ts` | changeOwnershipCore, reverseChangeOwnershipCore | ✅ | `query-operations` | — |
...
Coverage: **24/30** cores reachable by an assistant tool (2 internal, 5 deferred gap).
