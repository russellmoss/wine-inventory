...
| `src/lib/grower/grower-core.ts` | createGrowerCore | ❌ | — | deferred gap |
...
| `src/lib/owner/owner-core.ts` | createOwnerCore | ❌ | — | deferred gap |
...
Coverage: **25/30** cores reachable by an assistant tool (2 internal, 4 deferred gap).
