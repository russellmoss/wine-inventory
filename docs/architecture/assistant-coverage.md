...
| `src/lib/equipment/equipment-core.ts` | createEquipmentAssetCore, createEquipmentAssetsFromInvoiceCore | ✅ | `propose-work-order` | — |
...
| `src/lib/ingest/manual-invoice-core.ts` | createManualInvoiceCore | ✅ | `ingest-documents` | — |
...
Coverage: **22/25** cores reachable by an assistant tool (2 internal, 2 deferred gap).
