...
| `src/lib/vessels/group-core.ts` | getGroupDetailCore, listGroupDetailsCore, getGroupRollupsCore, getGroupToppingStatusCore, findGroupByNameCore, configureGroupCore, archiveGroupCore, addGroupMemberCore, removeGroupMemberCore, reorderGroupMembersCore | ✅ | `query-cellar-contents` | internal |
...
Coverage: **40/52** cores reachable by an assistant tool (13 internal, 2 deferred gap).
