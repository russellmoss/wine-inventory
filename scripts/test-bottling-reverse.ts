...
async function main() {
  ...
  const input = (bottles: number) => ({ vesselIds: [vessel.id], destinationLocationId: loc.id, skuName: SKU, skuVintage: 2025, bottlesProduced: bottles, abv: 13.5, date: new Date("2026-06-14") });
