/* @ds-bundle: {"format":3,"namespace":"SavvyDesignSystem_9598d9","components":[{"name":"Eyebrow","sourcePath":"components/brand/Eyebrow.jsx"},{"name":"Metric","sourcePath":"components/brand/Metric.jsx"},{"name":"Quote","sourcePath":"components/brand/Quote.jsx"},{"name":"Avatar","sourcePath":"components/core/Avatar.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Checkbox","sourcePath":"components/forms/Checkbox.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"}],"sourceHashes":{"components/brand/Eyebrow.jsx":"3a6df58dadaa","components/brand/Metric.jsx":"20bb0f8e9f44","components/brand/Quote.jsx":"1aae861e26a6","components/core/Avatar.jsx":"0180eebad83b","components/core/Badge.jsx":"a5c51c267510","components/core/Button.jsx":"dc7e6cf47014","components/core/Card.jsx":"1ff7afa6c4c6","components/forms/Checkbox.jsx":"6996803e4285","components/forms/Input.jsx":"1efb34b076bc","decks/competitive-deals/deck-stage.js":"9436a2deeb46","decks/competitive-losses/deck-stage.js":"9436a2deeb46","ui_kits/website/sections.jsx":"cd603b8b9575"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.SavvyDesignSystem_9598d9 = window.SavvyDesignSystem_9598d9 || {});
...
function Quote({
  ...
  const mark = markSrc || (onDark ? "../../assets/illustrations/quote-white.png" : "../../assets/illustrations/quote-gold.png");
...
function Avatar({
  ...
  const tones = {
    ...
    green: {
      bg: "rgba(23,82,66,0.12)",
      fg: "var(--deep-green)"
    },
    blue: {
      bg: "rgba(9,89,114,0.12)",
      fg: "var(--deep-blue)"
    },
    maroon: {
      bg: "rgba(107,72,77,0.14)",
      fg: "var(--maroon)"
    },
    ink: {
      bg: "var(--paper-200)",
...
function Badge({
  ...
  const tones = {
    ...
    green: {
      fg: "var(--deep-green)",
      soft: "rgba(23,82,66,0.12)",
      solid: "var(--deep-green)"
    },
    blue: {
      fg: "var(--deep-blue)",
      soft: "rgba(9,89,114,0.12)",
      solid: "var(--deep-blue)"
    },
    maroon: {
      fg: "var(--maroon)",
      soft: "rgba(107,72,77,0.14)",
      solid: "var(--maroon)"
    },
    red: {
      fg: "var(--red)",
      soft: "rgba(182,61,53,0.12)",
      solid: "var(--red)"
    }
  };
  ...
  const look = variant === "solid" ? {
    background: t.solid,
    color: tone === "gold" ? "var(--accent-on)" : "var(--savvy-white)"
  } : variant === "outline" ? {
...
function Button({
  ...
  const base = {
    ...
    transition: "background var(--duration-fast) var(--ease-standard), color var(--duration-fast) var(--ease-standard), border-color var(--duration-fast) var(--ease-standard), box-shadow var(--duration-fast) var(--ease-standard), transform var(--duration-fast) var(--ease-standard)",
...
function Input({
  ...
  const s = sizes[size] || sizes.md;
  const borderColor = error ? "var(--danger)" : focus ? "var(--savvy-gold)" : "var(--border-strong)";
...
// decks/competitive-deals/deck-stage.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "decks/competitive-deals/deck-stage.js", error: String((e && e.message) || e) }); }

// decks/competitive-losses/deck-stage.js
try { (() => {
// @ds-adherence-ignore -- omelette starter scaffold (raw elements/hex/px by design)
/* BEGIN USAGE */
/**
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "decks/competitive-losses/deck-stage.js", error: String((e && e.message) || e) }); }
...
function Nav({
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    src: `${ASSET}/logos/savvy-wordmark-black.png`,
    alt: "Savvy",
    style: {
      height: 26
    }
    ...
    href: "#",
    style: link
  }, "For advisors"), /*#__PURE__*/React.createElement("a", {
    href: "#",
    style: link
...
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    src: `${ASSET}/illustrations/gold/globe-striped.png`,
    alt: "",
    "aria-hidden": "true",
    style: {
      position: "absolute",
    ...
    rule: true
  }, "Wealth management, reimagined"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "A smarter home", /*#__PURE__*/React.createElement("br", null), "for your wealth"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-body)",
      fontSize: 21,
      lineHeight: 1.5,
  ...
  }, "Savvy pairs an experienced fiduciary advisor with technology that handles the busywork \u2014 so the relationship, not the paperwork, stays at the center."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 14,
      marginTop: 6
...
function Metrics() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    value: "$2.4B",
    caption: "Assets under advisement"
  }), /*#__PURE__*/React.createElement(Metric, {
    value: "98%",
    caption: "Client retention, year over year"
  }), /*#__PURE__*/React.createElement(Metric, {
    value: "12 yrs",
    caption: "Average advisor tenure",
    serif: true
  })));
}
function ValueProps() {
  const items = [{
    art: "sphere-equator",
    title: "A real advisor",
    body: "A dedicated fiduciary who knows your full picture — not a call-center queue."
  }, {
    art: "orbit-dot",
    title: "Software that works",
    body: "Planning, transfers, and reporting handled quietly in the background."
  }, {
    art: "venn-two",
    title: "One clear view",
    body: "Every account, goal, and document in a single, calm place."
  }];
  return /*#__PURE__*/React.createElement("section", {
    style: {
      maxWidth: 1180,
  ...
  }, /*#__PURE__*/React.createElement(Eyebrow, null, "What it includes"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "var(--font-heading)",
      fontWeight: 300,
      fontSize: 44,
  ...
  }, "One platform, three promises")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(3, 1fr)",
      gap: 24
    ...
    src: `${ASSET}/illustrations/gold/${it.art}.png`,
    alt: "",
    style: {
      height: 60
    }
...
function Testimonial() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    onDark: true,
    name: "Maya Iyer",
    role: "Founder, Iyer Wealth",
    markSrc: `${ASSET}/illustrations/quote-white.png`
...
function CTA({
  ...
  }, "See what calm looks like"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "var(--font-body)",
      fontSize: 18,
      lineHeight: 1.5,
  ...
  }, "Leave your email and an advisor will reach out within one business day.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 14
...
function Footer() {
  ...
  return /*#__PURE__*/React.createElement("footer", {
    ...
    src: `${ASSET}/logos/savvy-wordmark-white.png`,
    alt: "Savvy",
    style: {
      height: 28
    }
  ...
  }, "A smarter home for your wealth. Advisors and technology, working as one.")), col("Product", ["How it works", "For advisors", "Pricing", "Security"]), col("Company", ["About", "Careers", "Press", "Contact"]), col("Legal", ["Disclosures", "Privacy", "Terms", "Form ADV"])), /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 1180,
      margin: "0 auto",
      padding: "0 32px 40px",
  ...
  }, "\xA9 2026 Savvy Advisors, Inc. Investment advisory services offered through Savvy Advisors, an SEC-registered investment adviser."));
}
Object.assign(window, {
  SavvyNav: Nav,
  SavvyHero: Hero,
  SavvyMetrics: Metrics,
  SavvyValueProps: ValueProps,
  SavvyTestimonial: Testimonial,
  SavvyCTA: CTA,
  SavvyFooter: Footer
});
