...
/**
 * Savvy Badge — small status / category label. Quiet by default
 * (soft tinted fills), or an uppercase tracked "eyebrow" style.
 */
export function Badge({
  ...
  const tones = {
    ...
    gold:    { fg: "var(--savvy-gold)", soft: "var(--accent-soft)", solid: "var(--accent)" },
  ...
  const look =
    variant === "solid"
      ? { background: t.solid, color: tone === "gold" ? "var(--accent-on)" : "var(--savvy-white)" }
      : variant === "outline"
