...
**Plan 080 (unified inventory) — Waves 1 (PR #351) + 2 (PR #376) MERGED. Wave 4 addendum (U14-U17, field-report hardening) drafted → PR #389. NEXT: Wave 3 (U5 mixed-invoice apply, council-review first) and/or Wave 4 — they share no files, so they can run in parallel worktrees.**
