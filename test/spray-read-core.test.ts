...
const materialLine = (over: Partial<SprayMaterialLineRow> = {}): SprayMaterialLineRow => ({
  ...
  factsPublishedRevisionId: "rev_cuid_3",
  factsApprilAsOf: new Date("2026-05-20T00:00:00Z"),
  factsCdprAsOf: new Date("2026-06-01T00:00:00Z"),
  factsResistanceArtifactSha256: "abc123",
