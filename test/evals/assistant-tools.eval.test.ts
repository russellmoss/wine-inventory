...
const REQUIRED_READ_TOOL_NAMES = ["query_cellar_contents", "query_measurements", "query_operations", "query_climate"];
...
const UNCOVERED_OK: Record<string, string> = {
  ...
  reverse_intake: "arg is an ingestedInvoiceId resolved from query_recent_intakes (not NL-derivable); the reverse is exercised end-to-end by verify:ingest (apply→reverse asserts zero lots/A/P + discarded)",
};
